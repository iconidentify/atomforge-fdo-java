...
public enum AolsockAtom implements DslAtom {
    JAVA_MANAGE,
    JAVA_EXECUTE,
    JAVA_MIMETYPE,
    JAVA_ARGS;
    ...
    AolsockAtom() {
        String atomName = "aolsock_" + name().toLowerCase();
    ...
    public static AolsockAtom fromAtomNumber(int atomNumber) {
        for (AolsockAtom atom : values()) {
    ...
    public static AolsockAtom fromName(String name) {
